      ...
      <div className="container flex flex-col items-center justify-between gap-x-20 gap-y-10 lg:flex-row">
        <FadeInLeftWithSlowBounce className="relative min-h-[400px] w-full basis-full xl:min-h-[600px] xl:basis-1/2">
          <Image
            ...
            src="/images/pages/services/pre_departure_briefing/why_choose_us/why_choose_us.svg"
        ...
        <FadeInRightWithSlowBounce className="basis-full space-y-5 xl:basis-1/2">
          ...
          <h2 className="text-center text-3xl font-semibold lg:text-left">
            Why Choose Our Pre-departure Briefing Service?
          </h2>
          <p className="text-center text-sm font-medium lg:text-left">
            Our Pre-departure Briefing Service offers personalized guidance,
            vital information, and practical resources to ensure you are fully
            prepared for your study abroad journey, making your transition
          ...
          <div className="grid grid-cols-1 gap-x-5 gap-y-6 xl:grid-cols-2">
            ...
            <div className="flex items-center justify-start gap-x-3">
              <div className="basis-auto">
                <Image
                  src="/images/pages/services/pre_departure_briefing/why_choose_us/1.svg"
            ...
            <div className="flex items-center justify-start gap-x-3">
              <div className="basis-auto">
                <Image
                  src="/images/pages/services/pre_departure_briefing/why_choose_us/2.svg"
                  alt="Comprehensive Research"
                  height={50}
                  width={50}
                />
            ...
            <div className="flex items-center justify-start gap-x-3">
              <div className="basis-auto">
                <Image
                  src="/images/pages/services/pre_departure_briefing/why_choose_us/3.svg"
                  alt="Comprehensive Research"
                  height={50}
                  width={50}
                />
            ...
            <div className="flex items-center justify-start gap-x-3">
              <div className="basis-auto">
                <Image
                  src="/images/pages/services/pre_departure_briefing/why_choose_us/4.svg"
                  alt="Comprehensive Research"
                  height={50}
                  width={50}
                />
